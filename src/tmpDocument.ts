...
export async function createTempDocument(document: TextDocument, node: Node) {
...
export function deleteTempDocument(uri: Uri) {
...
export function createTempPosition(position: Position, node: Node) {
    const range = rangeOfNode(node)
...
export async function openTempDocument(uri: Uri, node: Node) {
